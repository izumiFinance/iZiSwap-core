...
library LogPowMath {
    ...
    function getSqrtRatioAtTick(int24 tick) internal pure returns (uint160 sqrtPriceX96) {
        ...
        // we then downcast because we know the result always fits within 160 bits due to oux tick input constraint
        // we round up in the division so getTickAtSqrtRatio oy the output price is always consistent
