...
async function swapX2YDesireYNotPayEnough(testSwap, trader, tokenX, tokenY, fee, desireY, lowPt) {
    const traderAmountXBefore = (await tokenX.balanceOf(trader.address)).toString();
    const traderAmountYBefore = (await tokenY.balanceOf(trader.address)).toString();
    await testSwap.connect(trader).swapX2YDesireYNotPayEnough(tokenX.address, tokenY.address, fee, desireY, lowPt);
    const traderAmountXAfter = (await tokenX.balanceOf(trader.address)).toString();
    const traderAmountYAfter = (await tokenY.balanceOf(trader.address)).toString();
    return {
        costX: stringMinus(traderAmountXBefore, traderAmountXAfter),
...
describe("swap", function () {
    ...
    it("(1)", async function () {
        ...
        const swap0 = await swapX2YDesireY(testSwap, trader, tokenX, tokenY, 3000, getSum([
            acquireYAt2050, acquireY_2051_3000
        ]), -15000);

        expect(swap0.acquireY).to.equal(getSum([acquireYAt2050, acquireY_2051_3000]));
        ...
        const swap1 = await swapX2YDesireY(testSwap, trader, tokenX, tokenY, 3000, getSum([
            acquireYAt1700_1, acquireY_1701_1900, acquireY_1900_2050, acquireYAt2050_1
        ]), -15000);
        ...
        const swap2 = await swapX2YDesireY(testSwap, trader, tokenX, tokenY, 3000, getSum([
            acquireY_50_1000, acquireY_1550_1700, acquireYAt1700_2, '10000000000000000000000'
        ]), 50);
        ...
        const swap3 = await swapX2YDesireY(testSwap, trader, tokenX, tokenY, 3000, getSum([
            acquireYAtM250_3, acquireY_M250_0, acquireY_0_50
        ]), -100000);
        ...
        const costXAtM1206_4 = l2x('800000', (await logPowMath.getSqrtPrice(-1206)).toString(), true);
        const acquireYAtM1206_4 = l2y('800000', (await logPowMath.getSqrtPrice(-1206)).toString(), false);
        ...
        const costX_M1206_M1050_WithFee = amountAddFee(getSum([costXAtM1206_4, costX_M1205_M1050]));

        const acquireYAtM1050_4 = '20000000000000000000';
        const costXAtM1050_4 = await getCostXFromYAt((await logPowMath.getSqrtPrice(-1050)).toString(), acquireYAtM1050_4);
        const costXAtM1050_WithFee_4 = amountAddFee(costXAtM1050_4);
        ...
        const swap4 = await swapX2YDesireY(testSwap, trader, tokenX, tokenY, 3000, getSum([
            acquireYAtM1206_4, acquireY_M1205_M1050, acquireYAtM1050_4, acquireY_M1050_M700, acquireY_M700_M250, acquireYAtM250_4
        ]), -100000);
        expect(swap4.acquireY).to.equal(getSum([acquireYAtM1206_4, acquireY_M1205_M1050, acquireYAtM1050_4, acquireY_M1050_M700, acquireY_M700_M250, acquireYAtM250_4]));
        expect(swap4.costX).to.equal(getSum([
            costX_M1206_M1050_WithFee, costXAtM1050_WithFee_4, costX_M1049_M700_WithFee, costX_M700_M250_WithFee, costXAtM250_WithFee_4
        ]));
        const state4 = await getState(pool);
        expect(state4.liquidity).to.equal('1000000')
        expect(state4.liquidityX).to.equal('800000')
        expect(state4.currentPoint).to.equal('-1206')
    });
    ...
    it("(2)", async function () {
        ...
        const swap0 = await swapX2YDesireY(testSwap, trader, tokenX, tokenY, 3000, acquireY_2000_3001, -15000);
        ...
        const swap1 = await swapX2YDesireY(testSwap, trader, tokenX, tokenY, 3000, getSum([acquireY_M3000_0, acquireY_0_2000]), -15000);
        ...
        console.log('acquireYAtM3000: ', acquireYAtM3000)
        console.log('acquireY_M4000_M3000: ', acquireY_M4000_M3000)
        console.log('acquireY_M5000_M4000: ', acquireY_M5000_M4000)
        console.log('----------')
        const swap2 = await swapX2YDesireY(testSwap, trader, tokenX, tokenY, 3000, getSum([acquireYAtM3000, acquireY_M4000_M3000, acquireY_M5000_M4000]), -5000);
        console.log('----------')
        expect(swap2.costX).to.equal(getSum([costX_M4000_M3000_WithFee, costXAtM3000_WithFee, costX_M5000_M4000_WithFee]));
        expect(swap2.acquireY).to.equal(getSum([acquireY_M4000_M3000, acquireYAtM3000, acquireY_M5000_M4000]));
        ...
        const swap4 = await swapX2YDesireY(testSwap, trader, tokenX, tokenY, 3000, getSum([acquireYAtM7000_4, acquireY_M6999_M6000, acquireYAtM6000, acquireY_M6000_M5000]), -15000);
        ...
        const swap5 = await swapX2YDesireY(testSwap, trader, tokenX, tokenY, 3000, getSum([acquireYAtM7000_5, acquireY_M8000_M7000, acquireYAtM8000]), -15000);
    ...
    it("(3)", async function () {
        ...
        const swap0 = await swapX2YDesireY(testSwap, trader, tokenX, tokenY, 3000, getSum([acquireY_1000_3000, acquireYAt1000]), -15000);
        ...
        const swap1 = await swapX2YDesireY(testSwap, trader, tokenX, tokenY, 3000, getSum([acquireYAtM3000, acquireY_M3000_M2000, acquireY_M2000_0, acquireY_0_1000]), -15000);
        ...
        const swap2 = await swapX2YDesireY(testSwap, trader, tokenX, tokenY, 3000, getSum([acquireYAtM5000, acquireY_M5000_M4000]), -15000);
        ...
        await checkLimOrder(
            '0', costXAtM5000, costXAtM5000,
            '0', '0', '0',
            '0', '0',
            costXAtM5000, '0', poolAddr, -5000);
        ...
        const swap3 = await swapX2YDesireY(testSwap, trader, tokenX, tokenY, 3000, getSum([acquireYAtM6000, acquireY_M6000_M5000]), -15000);
        ...
        const swap4 = await swapX2YDesireY(testSwap, trader, tokenX, tokenY, 3000, getSum([acquireY_M8000_M7000, acquireY_M7000_M6000]), -15000);
        ...
        const swap5 = await swapX2YDesireY(testSwap, trader, tokenX, tokenY, 3000, acquireYAtM8000, -15000);
    ...
    it("(4)", async function () {
        ...
        const swap0 = await swapX2YDesireY(testSwap, trader, tokenX, tokenY, 3000, getSum([acquireY_2501_3000, acquireYAt2500_0]), -15000);
        ...
        const swap1 = await swapX2YDesireY(testSwap, trader, tokenX, tokenY, 3000, getSum([acquireYAt2500_1, acquireY_2350_2500, acquireYAt2350, acquireY_0_2350, acquireY_M9999_0, acquireYAtM10000_1]), -15000);
        ...
        console.log('1990000: ', l2y('1990000', (await logPowMath.getSqrtPrice(-10000)).toString(), false))
        console.log('1990001: ', l2y('1990001', (await logPowMath.getSqrtPrice(-10000)).toString(), false))
        ...
        // const desireXAt10000_2 = stringMinus(acquireYAt10000_2, '1');

        const costXAt10000_WithFee_2 = amountAddFee(costXAt10000_2);


        const swap2 = await swapX2YDesireY(testSwap, trader, tokenX, tokenY, 3000, acquireYAt10000_2, -15000);
        ...
        const swap3 = await swapX2YDesireY(testSwap, trader, tokenX, tokenY, 3000, acquireYAt10000_3, -15000);
    ...
    it("(5) test not pay enough", async function () {
        ...
        try {
            await swapX2YDesireYNotPayEnough(testSwap, trader, tokenX, tokenY, 3000, getSum([
                acquireYAt2050, acquireY_2051_3000
            ]), -15000);
        } catch(e) {
