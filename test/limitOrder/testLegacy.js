...
describe("swap", function () {
    ...
    it("", async function () {
        ...
        const swap2 = await swapX2Y(testSwap, trader, tokenX, tokenY, 3000, '100000000000000000000000', 700)
        ...
        const swap3 = await swapX2Y(testSwap, trader, tokenX, tokenY, 3000, '100000000000000000000000', 700)
        ...
        const swap4 = await swapX2Y(testSwap, trader, tokenX, tokenY, 3000, costXAt700_WithFee_4, 700)
        ...
        const swap5 = await swapY2X(testSwap, trader, tokenX, tokenY, 3000, costYAt700_WithFee_5, 701)
        ...
        const swap6 = await swapY2X(testSwap, trader, tokenX, tokenY, 3000, '100000000000000000000000', 701)
        ...
        const swap7 = await swapY2X(testSwap, trader, tokenX, tokenY, 3000, '100000000000000000000000', 701)
        ...
        const swap8 = await swapY2X(testSwap, trader, tokenX, tokenY, 3000, costYAt700_WithFee_8, 701)
