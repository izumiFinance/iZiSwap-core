...
describe("swap", function () {
  it("swap with limorder x2y range complex", async function () {
    ...
    [acquireY_5100, costX_5100, liquidityXExpect] = x2yAtLiquidity(5100, rate, costX_5100, BigNumber("20000"), liquidityX);
    ...
    [acquireY_4869_Remain, costX_4869_Remain, liquidityXExpect_4869] = x2yAtLiquidity(4869, rate, costX_4869_Remain, BigNumber("10000"), BigNumber('0'));
    ...
    [currPt, liquidity, liquidityX_4869] = await printState(poolAddr);
    expect(currPt).to.equal(4869);
    expect(liquidity.toFixed(0)).to.equal("10000");
    expect(liquidityX_4869.toFixed(0)).to.equal(liquidityXExpect_4869.toFixed(0));
    ...
    expectFeeX2 = feeScale2Fee(feeScaleXMiner2_q128, BigNumber('20000')).toFixed(0);
